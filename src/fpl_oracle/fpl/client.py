...
Only the `entry` endpoints needed for roster verification live here for
now (bootstrap-static + the player DB land in Phase 2 per PLAN.md). All
FPL network calls go through here, with on-disk caching in
